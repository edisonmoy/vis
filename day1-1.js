...
import { BokehPass } from "https://cdn.jsdelivr.net/npm/three@0.120.0/examples/jsm/postprocessing/BokehPass.js";
import { GUI } from "https://cdn.jsdelivr.net/npm/three@0.120.0/examples/jsm/libs/dat.gui.module.js";
...
camera.position.set(0, 4.25, 4).setLength(5);
...
let g = new THREE.CylinderBufferGeometry(0.5, 0.5, 0.000001, 6);
